                    ...
                    <div className="contact-content flex gap-16">
                        <div className="contact-left flex-1">
                            <p className="contact-summary text-justify">
                                ...
                                trong việc lên kế hoạch cho chuyến đi hoàn hảo.
                                Dù bạn đang tìm kiếm một hành trình thư giãn,
                                khám phá, hay một chuyến đi công tác kết hợp du
                                lịch, đội ngũ của chúng tôi sẽ giúp bạn chọn lựa
                                những giải pháp phù hợp nhất.
                            </p>
                            <p className="contact-summary mt-4 text-justify">
                                Liên hệ ngay với chúng tôi qua form bên phải,
                                hoặc đến trực tiếp văn phòng để được tư vấn chi
                                tiết và tận tâm!
                            </p>
                        </div>
