            ...
            <section className={classNames("row", styles["tour_content"])}>
                      ...
                      <ul className="pl-6 mb-4">
                        {
                          tourDetail.routes.map((route, index) => (
                            <li key={index}>Chặng {index + 1}: {route.description}</li>
                          ))
                        }
                      </ul>
                    </div>
              ...
              <div className="col col-lg-4 col-md-3 col-sm-12 col-sm-order-1">
                <aside className={styles.sidebar}>
                  ...
                  <p className="text-gray-500 line-through text-2xl">{convertPrice(tourDetail.price + 900000)}đ</p>
                  <p className="text-red-600 font-bold text-3xl">
                    Giá mới: <span className="text-black">{convertPrice(tourDetail.price)}đ</span>
                  </p>
