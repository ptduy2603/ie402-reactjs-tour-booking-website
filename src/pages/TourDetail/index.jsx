    ...
    <div className="inner py-4">
      <section className="row">
                ...
                <ul className="list-disc pl-6 text-gray-700">
                  <li>
                    ...
                    <ul className="list-disc pl-6 mt-2">
                      <li>
                        Trẻ em dưới 2 tuổi: thu 300.000đ. Gia đình tự lo cho bé
                        ăn ngủ.
                      </li>
                      <li>
                        Trẻ em từ 2 đến dưới 6 tuổi: mua 100% VMB người lớn. Gia
                        đình tự lo cho bé ăn ngủ và tự trả phí tham quan (nếu
                        có).
                      </li>
                      <li>
                        Hai người lớn chỉ được kèm 1 trẻ em dưới 6 tuổi. Từ trẻ
                        thứ 2 trở lên, mỗi em phải đóng bằng giá trẻ em từ 6 đến
                        11 tuổi.
                      </li>
                      <li>
                        Trẻ em từ 6 - 11 tuổi: tiêu chuẩn gồm VMB, ăn uống và
                        tham quan theo chương trình, ngủ chung giường với phụ
                        huynh.
                      </li>
                      <li>
                        Trẻ em trên 11 tuổi: áp dụng giá và các tiêu chuẩn dịch
                        vụ như người lớn.
                      </li>
                    </ul>
                  </li>
        ...
        <div className="col col-lg-4 col-md-3 col-sm-12">
          <aside className="bg-gray-100 shadow-lg p-6">
